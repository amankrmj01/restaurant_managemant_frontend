...
class EditDialog extends StatefulWidget {
  ...
  const EditDialog({super.key, this.restaurant});
...
class _EditDialogState extends State<EditDialog> {
  ...
  //   html.File mediaFile = new html.File(mediaData.data!, mediaData.fileName!, {
  //     'type': mimeType,
  //   });
  //
  //   setState(() {
  ...
  Future<void> _pickImage() async {
    ...
    if (mediaData != null) {
      ...
      if (mimeType != null) {
        setState(() {
          _cloudFile = null; // Reset `_cloudFile` as it's not used here.
          _fileBytes = mediaData.data;
        });
      }
    }
                      ...
                      Row(
                        children: [
                          ...
                          Material(
                            ...
                            color: Colors.pink.withAlpha((255 * 0.2).toInt()),
                            child: Container(
                              height: 275,
                              width: 220,
